/* This is jsonfc, an easy to use and portable json parser for C.
 * This library was made by ZikiFlicky at ziki.flicky@gmail.com
 * This is free software, you can use it for any use you want
 * This is written in ansi-c/c89 and should be really easy to use on
 * older systems and/or older compilers.
 */
